...
var_auth_cnt,Authorization Count,Number of authorizations,feature_store,authorization,xgboost
var_fraud_flag,Fraud Flag,Predicted fraud indicator,model_features,risk,rnn
"""
