...
- chooses default SQL template packs by variable type from `amex_ai_agent/cdit_alert_rationalization/`
- executes those queries sequentially when `execute_sql=true`
- returns a generated summary and optionally an `llm_followup_prompt` for deeper SQL
